 ...
 */
function lgd_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'lgd_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.lgd-front-page) .entry-title,
...
.colors-custom .lgd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.lgd-front-page .panel-content .recent-posts article,
...
.colors-custom.lgd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'lgd_custom_colors_css', $css, $hue, $saturation );
}
